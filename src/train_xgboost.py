...
MODEL_PATH = OUTPUT_DIR / "xgboost_improved_model.joblib"
FEATURES_PATH = OUTPUT_DIR / "xgboost_feature_columns.json"
METRICS_PATH = OUTPUT_DIR / "xgboost_metrics.json"
IMPORTANCE_CSV_PATH = OUTPUT_DIR / "xgboost_feature_importance.csv"
PR_CURVE_PATH = OUTPUT_DIR / "xgboost_pr_curve.png"
THRESHOLD_SEARCH_CSV_PATH = OUTPUT_DIR / "xgboost_threshold_search.csv"
...
print("=" * 70)
print("[START] Treinamento XGBoost com Group Split")
...
print("=" * 70)
print("[RESULTADOS - THRESHOLD PADRÃO]")
...
print("\n[CLASSIFICATION REPORT - THRESHOLD PADRÃO]")
print(classification_report(y_test, y_pred, digits=4, zero_division=0))

print("[CONFUSION MATRIX - THRESHOLD PADRÃO]")
print(confusion_matrix(y_test, y_pred))

print("\n[PRED DISTRIBUTION - THRESHOLD PADRÃO]")
...
print(f"[DONE] Threshold Search: {THRESHOLD_SEARCH_CSV_PATH}")
print("=" * 70)
