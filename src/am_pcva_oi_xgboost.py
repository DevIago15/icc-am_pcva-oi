...
class XGBoostLocalSearchPolicy(LocalSearchPolicy):
    """
    Policy baseada em modelo treinado com XGBoost.
    """
...
class AMPCVAOI:
    ...
    def _maybe_apply_local_search(
        ...
        # Se houver modelo, usa o modelo diretamente.
        # Se não houver, aplica LS sempre que a estrutura permitir.
...
def main() -> None:
    ...
    print("=" * 70)
    print("[RESULTADO FINAL - AM_PCVA_OI + XGBOOST]")
