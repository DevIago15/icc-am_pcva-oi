...
MODEL_PATH = OUTPUT_DIR / "xgboost_efficiency_model.joblib"
FEATURES_PATH = OUTPUT_DIR / "xgboost_efficiency_feature_columns.json"
METRICS_PATH = OUTPUT_DIR / "xgboost_efficiency_metrics.json"
IMPORTANCE_CSV_PATH = OUTPUT_DIR / "xgboost_efficiency_feature_importance.csv"
PR_CURVE_PATH = OUTPUT_DIR / "xgboost_efficiency_pr_curve.png"
THRESHOLD_SEARCH_CSV_PATH = OUTPUT_DIR / "xgboost_efficiency_threshold_search.csv"
...
def main() -> None:
    ...
    print("=" * 70)
    print("[START] Treinamento XGBoost para target de eficiencia")
    ...
    plt.title("Curva Precision-Recall - XGBoost (Efficiency)")
    plt.tight_layout()
